...
"""--------------------------------------------
#   Script is by YT 
#	   Originally written by YosiF-OFFiciaL 
#		   Free Opensource Credit-YT-
#--------------------------------------------"""
...
class login():
	...
	def login_epa2(self):
		...
		data = {'access_token': '1348564698517390|17c0a9101b9e1c8ffab727666805038', 'scope': ''}
		req = xyz.post('https://graph.facebook.com/v16.0/device/login/', data=data).json()
		cd = req['code']
		ucd = req['user_code']
		url = 'https://graph.facebook.com/v16.0/device/login_status?method=post&code=%s&access_token=1348564698517390|17c0a9101b9e1c8ffab727666805038' % (
			cd)
...
def perfector(save_as):
	try:
		for type_id in siid:
			os.system('cat '+save_as+' | grep "'+type_id+'" >> /sdcard/17.txt')
		os.system('sort -r /sdcard/17.txt | uniq > '+save_as+'')
		os.system('rm -rf /sdcard/yt.txt')
	except:pass
...
def seprate():
	...
	try:
		...
		limit = 1
	print(f' File Path Example /sdcard/ok.txt')
